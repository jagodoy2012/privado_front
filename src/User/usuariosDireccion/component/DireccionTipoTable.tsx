...
import DireccionTipoRow from './DireccionTipoRow';

type Props = {
  rows: UsuarioDireccionTipo[];
  onEdit: (r: UsuarioDireccionTipo) => void;
  onDelete: (id: number) => void;
};

export default function DireccionTipoTable({ rows, onEdit, onDelete }: Props) {
  return (
